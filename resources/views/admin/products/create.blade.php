        ...
        <div class="card-body">
            <form method="post" action="{{ route('admin.products.store') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" name="stock" min="1" id="basic-default-phone"
                            class="form-control phone-mask" placeholder="Nhập số lượng" />
                        @error('stock')
                ...
                <div class="mb-3">
                    ...
                    @enderror
                    <textarea id="description" name="description" class="form-control" rows="10" placeholder="Nhập mô tả sản phẩm."></textarea>
                </div>
